...
@section('create.reservations')
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Create a New Reservation</h1>
    @if (session('success'))
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="guestNumber" type="text"
                                ...
                                value="{{ old('guestNumber') }}" required autocomplete="guestNumber" autofocus>
                            @error('guestNumber')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
